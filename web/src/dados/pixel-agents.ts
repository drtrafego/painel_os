...
export const PIXEL_AGENTS: PixelAgent[] = [
  ...
  { id: 'tereza', nome: 'Tereza', papel: 'Regente de tráfego', squad: 'tráfego', área: 'Regência', abreviação: 'TE', cor: '#8b5cf6', aliases: ['tereza-regente', 'regente-trafego'] },
  { id: 'jade', nome: 'Jade', papel: 'Fiscal de tráfego', squad: 'tráfego', área: 'Fiscalização', abreviação: 'JA', cor: '#a855f7', aliases: ['jade-fiscal', 'fiscal-trafego'] },
  { id: 'heitor', nome: 'Heitor', papel: 'Regente de bots', squad: 'bots', área: 'Regência', abreviação: 'HE', cor: '#c2410c', aliases: ['heitor-regente', 'regente-bots'] },
  { id: 'vitor', nome: 'Vitor', papel: 'Fiscal de bots', squad: 'bots', área: 'Fiscalização', abreviação: 'VI', cor: '#ea580c', aliases: ['vitor-fiscal', 'fiscal-bots'] },
  { id: 'dev', nome: 'Dev', papel: 'Desenvolvimento e código', squad: 'bots', área: 'Engenharia', abreviação: 'DV', cor: '#c2410c', aliases: ['desenvolvedor', 'desenvolvimento'] },
  { id: 'qa', nome: 'QA', papel: 'Testes e qualidade', squad: 'bots', área: 'Qualidade', abreviação: 'QA', cor: '#ea580c', aliases: ['testes', 'qualidade'] },
  { id: 'explore', nome: 'Explore', papel: 'Sonda e exploração', squad: 'bots', área: 'Exploração', abreviação: 'EX', cor: '#f97316', aliases: ['sonda-explore', 'exploracao'] },
